 ...
 *
 * No es una pantalla de producto: existe para poder ver y probar todos los
 * componentes base en sus estados mientras no hay router. Otro agente
 * sustituirá este fichero por el <RouterView />; se puede borrar tal cual.
 */
